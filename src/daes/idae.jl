...
function IDAEProblem(ϑ, f, u, g, ϕ, ū, ḡ, ψ, tspan::Tuple, tstep::Real, ics...;
...
function IDAEEnsemble(ϑ, f, u, g, ϕ, ū, ḡ, ψ, tspan::Tuple, tstep::Real, ics...; v̄ = _idae_default_v̄, f̄ = f,
