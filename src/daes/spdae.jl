...
Base.similar(equ::SPDAE, t₀::Real, q₀::StateVariable, p₀::StateVariable, λ₀::StateVariable = initial_multiplier(q₀, equ.λ₀), μ₀::StateVariable = initial_multiplier(λ₀, equ.μ₀); kwargs...) = similar(equ, equ.t₀, [q₀], [p₀], [λ₀], [μ₀]; kwargs...)
