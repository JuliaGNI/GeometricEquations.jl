...
@testset "$(rpad("Stochastic Differential Equations (SDE)",80))" begin
    sde = SDE(sde_v, sde_B, sde_v, TestNoise(), NullInvariants(),
...
@testset "$(rpad("Partitioned Stochastic Differential Equations (PSDE)",80))" begin
    ...
    psde4 = PSDE(
        psde_v, psde_f, psde_B, psde_G, TestNoise(); periodicity = NullPeriodicity())
...
@testset "$(rpad("Split Partitioned Stochastic Differential Equations (SPSDE)",80))" begin
    psde = SPSDE(
        ...
        TestNoise(), NullInvariants(), NullParameters(), NullPeriodicity())
    psde1 = SPSDE(spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1, spsde_G2, TestNoise())
    psde2 = SPSDE(spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1,
        spsde_G2, TestNoise(); invariants = NullInvariants())
    psde3 = SPSDE(spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1,
        spsde_G2, TestNoise(); parameters = NullParameters())
    psde4 = SPSDE(spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1,
        spsde_G2, TestNoise(); periodicity = NullPeriodicity())
    ...
    psde = SPSDE(
        spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1, spsde_G2, spsde_v, spsde_f1,
        TestNoise(), NullInvariants(), sde_param_types, NullPeriodicity())
    ...
    psdep = SPSDE(spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1,
        spsde_G2, TestNoise(); periodicity = ([0.0], [2π]))
