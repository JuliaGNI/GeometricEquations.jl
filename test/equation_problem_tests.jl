...
@testset "$(rpad("Geometric Problem",80))" begin
    ...
    @test arrtype(prob) == StateVariable{eltype(x₀), ndims(x₀), typeof(x₀),
        Tuple{typeof(x₀), typeof(x₀)}, typeof(falses(length(x₀)))}
...
@testset "$(rpad("ODE Problem",80))" begin
    ...
    @test prob ==
          ODEProblem(ode_eqs..., (t₀, t₁), Δt, ode_ics; invariants = NullInvariants(),
    ...
    @test prob == ODEProblem(
        ode_eqs..., (t₀, t₁), Δt, ode_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
...
@testset "$(rpad("SODE Problem",80))" begin
    ...
    @test prob ==
          SODEProblem(sode_eqs, (t₀, t₁), Δt, ode_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == SODEProblem(sode_eqs, (t₀, t₁), Δt, ode_ics_raw...)
    @test prob ==
          SODEProblem(
        sode_eqs, (t₀, t₁), Δt, ode_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    ...
    @test prob == SODEProblem(
        sode_eqs, sode_sols, (t₀, t₁), Δt, ode_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == SODEProblem(sode_eqs, sode_sols, (t₀, t₁), Δt, ode_ics...)
    @test prob == SODEProblem(
        sode_eqs, sode_sols, (t₀, t₁), Δt, ode_ics...; invariants = NullInvariants(),
    ...
    @test prob == SODEProblem(
        sode_eqs, sode_sols, (t₀, t₁), Δt, ode_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
...
@testset "$(rpad("PODE Problem",80))" begin
    ...
    @test prob ==
          PODEProblem(pode_eqs..., (t₀, t₁), Δt, pode_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == PODEProblem(pode_eqs..., (t₀, t₁), Δt, pode_ics...)
    @test prob ==
          PODEProblem(
        pode_eqs..., (t₀, t₁), Δt, pode_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == PODEProblem(pode_eqs..., (t₀, t₁), Δt, pode_ics_raw...)
    @test prob == PODEProblem(
        pode_eqs..., (t₀, t₁), Δt, pode_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
...
@testset "$(rpad("HODE Problem",80))" begin
    ...
    @test prob ==
          HODEProblem(hode_eqs..., (t₀, t₁), Δt, hode_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == HODEProblem(hode_eqs..., (t₀, t₁), Δt, hode_ics...)
    @test prob ==
          HODEProblem(
        hode_eqs..., (t₀, t₁), Δt, hode_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == HODEProblem(hode_eqs..., (t₀, t₁), Δt, hode_ics_raw...)
    @test prob == HODEProblem(
        hode_eqs..., (t₀, t₁), Δt, hode_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
...
@testset "$(rpad("LODE Problem",80))" begin
    ...
    @test prob ==
          LODEProblem(lode_eqs..., (t₀, t₁), Δt, lode_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == LODEProblem(lode_eqs..., (t₀, t₁), Δt, lode_ics...)
    @test prob ==
          LODEProblem(
        lode_eqs..., (t₀, t₁), Δt, lode_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
...
@testset "$(rpad("DAE Problem",80))" begin
    ...
    @test prob ==
          DAEProblem(dae_eqs..., (t₀, t₁), Δt, dae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == DAEProblem(dae_eqs..., (t₀, t₁), Δt, dae_ics_full)
    @test prob ==
          DAEProblem(dae_eqs..., (t₀, t₁), Δt, dae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == DAEProblem(dae_eqs..., (t₀, t₁), Δt, dae_ics...)
    @test prob ==
          DAEProblem(dae_eqs..., (t₀, t₁), Δt, dae_ics...; invariants = NullInvariants(),
    ...
    @test prob == DAEProblem(
        dae_eqs..., (t₀, t₁), Δt, dae_ics_full...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    ...
    @test prob ==
          DAEProblem(dae_eqs_full..., (t₀, t₁), Δt, dae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == DAEProblem(dae_eqs_full..., (t₀, t₁), Δt, dae_ics_full)
    @test prob == DAEProblem(
        dae_eqs_full..., (t₀, t₁), Δt, dae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == DAEProblem(dae_eqs_full..., (t₀, t₁), Δt, dae_ics...)
    @test prob == DAEProblem(
        dae_eqs_full..., (t₀, t₁), Δt, dae_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == DAEProblem(dae_eqs_full..., (t₀, t₁), Δt, dae_ics_full...)
    @test prob == DAEProblem(
        dae_eqs_full..., (t₀, t₁), Δt, dae_ics_full...; invariants = NullInvariants(),
...
@testset "$(rpad("PDAE Problem",80))" begin
    ...
    @test prob ==
          PDAEProblem(pdae_eqs..., (t₀, t₁), Δt, pdae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == PDAEProblem(pdae_eqs..., (t₀, t₁), Δt, pdae_ics_full)
    @test prob == PDAEProblem(
        pdae_eqs..., (t₀, t₁), Δt, pdae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == PDAEProblem(pdae_eqs..., (t₀, t₁), Δt, pdae_ics...)
    @test prob ==
          PDAEProblem(
        pdae_eqs..., (t₀, t₁), Δt, pdae_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == PDAEProblem(pdae_eqs..., (t₀, t₁), Δt, pdae_ics_full...)
    @test prob == PDAEProblem(
        pdae_eqs..., (t₀, t₁), Δt, pdae_ics_full...; invariants = NullInvariants(),
    ...
    @test prob == PDAEProblem(
        pdae_eqs_full..., (t₀, t₁), Δt, pdae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == PDAEProblem(pdae_eqs_full..., (t₀, t₁), Δt, pdae_ics_full)
    @test prob == PDAEProblem(
        pdae_eqs_full..., (t₀, t₁), Δt, pdae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == PDAEProblem(pdae_eqs_full..., (t₀, t₁), Δt, pdae_ics...)
    @test prob == PDAEProblem(
        pdae_eqs_full..., (t₀, t₁), Δt, pdae_ics...; invariants = NullInvariants(),
    ...
    @test prob == PDAEProblem(
        pdae_eqs_full..., (t₀, t₁), Δt, pdae_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
...
@testset "$(rpad("HDAE Problem",80))" begin
    ...
    @test prob ==
          HDAEProblem(hdae_eqs..., (t₀, t₁), Δt, hdae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == HDAEProblem(hdae_eqs..., (t₀, t₁), Δt, hdae_ics_full)
    @test prob == HDAEProblem(
        hdae_eqs..., (t₀, t₁), Δt, hdae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == HDAEProblem(hdae_eqs..., (t₀, t₁), Δt, hdae_ics...)
    @test prob ==
          HDAEProblem(
        hdae_eqs..., (t₀, t₁), Δt, hdae_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == HDAEProblem(hdae_eqs..., (t₀, t₁), Δt, hdae_ics_full...)
    @test prob == HDAEProblem(
        hdae_eqs..., (t₀, t₁), Δt, hdae_ics_full...; invariants = NullInvariants(),
    ...
    @test prob == HDAEProblem(
        hdae_eqs_full..., (t₀, t₁), Δt, hdae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == HDAEProblem(hdae_eqs_full..., (t₀, t₁), Δt, hdae_ics_full)
    @test prob == HDAEProblem(
        hdae_eqs_full..., (t₀, t₁), Δt, hdae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == HDAEProblem(hdae_eqs_full..., (t₀, t₁), Δt, hdae_ics...)
    @test prob == HDAEProblem(
        hdae_eqs_full..., (t₀, t₁), Δt, hdae_ics...; invariants = NullInvariants(),
    ...
    @test prob == HDAEProblem(
        hdae_eqs_full..., (t₀, t₁), Δt, hdae_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
...
@testset "$(rpad("IDAE Problem",80))" begin
    ...
    @test prob ==
          IDAEProblem(idae_eqs..., (t₀, t₁), Δt, idae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == IDAEProblem(idae_eqs..., (t₀, t₁), Δt, idae_ics_full)
    @test prob == IDAEProblem(
        idae_eqs..., (t₀, t₁), Δt, idae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == IDAEProblem(idae_eqs..., (t₀, t₁), Δt, idae_ics...)
    @test prob ==
          IDAEProblem(
        idae_eqs..., (t₀, t₁), Δt, idae_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == IDAEProblem(idae_eqs..., (t₀, t₁), Δt, idae_ics_full...)
    @test prob == IDAEProblem(
        idae_eqs..., (t₀, t₁), Δt, idae_ics_full...; invariants = NullInvariants(),
    ...
    @test prob == IDAEProblem(
        idae_eqs_full..., (t₀, t₁), Δt, idae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == IDAEProblem(idae_eqs_full..., (t₀, t₁), Δt, idae_ics_full)
    @test prob == IDAEProblem(
        idae_eqs_full..., (t₀, t₁), Δt, idae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == IDAEProblem(idae_eqs_full..., (t₀, t₁), Δt, idae_ics)
    @test prob == IDAEProblem(
        idae_eqs_full..., (t₀, t₁), Δt, idae_ics; invariants = NullInvariants(),
    ...
    @test prob == IDAEProblem(
        idae_eqs_full..., (t₀, t₁), Δt, idae_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
...
@testset "$(rpad("LDAE Problem",80))" begin
    ...
    @test prob ==
          LDAEProblem(ldae_eqs..., (t₀, t₁), Δt, ldae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == LDAEProblem(ldae_eqs..., (t₀, t₁), Δt, ldae_ics_full)
    @test prob == LDAEProblem(
        ldae_eqs..., (t₀, t₁), Δt, ldae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == LDAEProblem(ldae_eqs..., (t₀, t₁), Δt, ldae_ics...)
    @test prob ==
          LDAEProblem(
        ldae_eqs..., (t₀, t₁), Δt, ldae_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == LDAEProblem(ldae_eqs..., (t₀, t₁), Δt, ldae_ics_full...)
    @test prob == LDAEProblem(
        ldae_eqs..., (t₀, t₁), Δt, ldae_ics_full...; invariants = NullInvariants(),
    ...
    @test prob == LDAEProblem(
        ldae_eqs_full..., (t₀, t₁), Δt, ldae_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == LDAEProblem(ldae_eqs_full..., (t₀, t₁), Δt, ldae_ics_full)
    @test prob == LDAEProblem(
        ldae_eqs_full..., (t₀, t₁), Δt, ldae_ics_full; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == LDAEProblem(ldae_eqs_full..., (t₀, t₁), Δt, ldae_ics...)
    @test prob == LDAEProblem(
        ldae_eqs_full..., (t₀, t₁), Δt, ldae_ics...; invariants = NullInvariants(),
    ...
    @test prob == LDAEProblem(
        ldae_eqs_full..., (t₀, t₁), Δt, ldae_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
...
@testset "$(rpad("SDE Problem",80))" begin
    ...
    @test prob == SDEProblem(
        sde_v, sde_B, TestNoise(), (t₀, t₁), Δt, sde_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == SDEProblem(sde_v, sde_B, TestNoise(), (t₀, t₁), Δt, sde_ics...)
    @test prob == SDEProblem(
        sde_v, sde_B, TestNoise(), (t₀, t₁), Δt, sde_ics...; invariants = NullInvariants(),
    ...
    @test prob == SDEProblem(sde_v, sde_B, TestNoise(), (t₀, t₁), Δt,
        sde_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
...
@testset "$(rpad("PSDE Problem",80))" begin
    ...
    @test prob == PSDEProblem(
        psde_v, psde_f, psde_B, psde_G, TestNoise(), (t₀, t₁), Δt, psde_ics)
    @test prob == PSDEProblem(psde_v, psde_f, psde_B, psde_G, TestNoise(), (t₀, t₁),
        Δt, psde_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == PSDEProblem(
        psde_v, psde_f, psde_B, psde_G, TestNoise(), (t₀, t₁), Δt, psde_ics...)
    @test prob == PSDEProblem(psde_v, psde_f, psde_B, psde_G, TestNoise(), (t₀, t₁),
        ...
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == PSDEProblem(
        psde_v, psde_f, psde_B, psde_G, TestNoise(), (t₀, t₁), Δt, psde_ics_raw...)
    @test prob == PSDEProblem(psde_v, psde_f, psde_B, psde_G, TestNoise(), (t₀, t₁),
        Δt, psde_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
...
@testset "$(rpad("SPSDE Problem",80))" begin
    ...
    @test prob == SPSDEProblem(spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1, spsde_G2,
        TestNoise(), (t₀, t₁), Δt, spsde_ics)
    @test prob == SPSDEProblem(spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1, spsde_G2,
        TestNoise(), (t₀, t₁), Δt, spsde_ics; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == SPSDEProblem(spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1, spsde_G2,
        TestNoise(), (t₀, t₁), Δt, spsde_ics...)
    @test prob == SPSDEProblem(
        spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1, spsde_G2, TestNoise(),
        (t₀, t₁), Δt, spsde_ics...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
    @test prob == SPSDEProblem(spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1, spsde_G2,
        TestNoise(), (t₀, t₁), Δt, spsde_ics_raw...)
    @test prob == SPSDEProblem(
        spsde_v, spsde_f1, spsde_f2, spsde_B, spsde_G1, spsde_G2, TestNoise(),
        (t₀, t₁), Δt, spsde_ics_raw...; invariants = NullInvariants(),
        parameters = NullParameters(), periodicity = NullPeriodicity())
end
