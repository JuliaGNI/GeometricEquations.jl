...
iode_ics_tpl = [
    (q = StateVariable(q_arr[1]), p = StateVariable(p_arr[1]),
        v = AlgebraicVariable(v_arr[1])),
    (q = StateVariable(q_arr[2]), p = StateVariable(p_arr[2]),
        v = AlgebraicVariable(v_arr[2]))
]
...
idae_ics = (q = StateVariable(q₀), p = StateVariable(p₀),
    v = AlgebraicVariable(v₀), λ = AlgebraicVariable(λ₀))
ldae_ics = (q = StateVariable(q₀), p = StateVariable(p₀),
    v = AlgebraicVariable(v₀), λ = AlgebraicVariable(λ₀))
...
pdae_ics_full = (q = StateVariable(q₀), p = StateVariable(p₀),
    λ = AlgebraicVariable(λ₀), μ = AlgebraicVariable(μ₀))
hdae_ics_full = (q = StateVariable(q₀), p = StateVariable(p₀),
    λ = AlgebraicVariable(λ₀), μ = AlgebraicVariable(μ₀))
idae_ics_full = (q = StateVariable(q₀), p = StateVariable(p₀), v = AlgebraicVariable(v₀),
    λ = AlgebraicVariable(λ₀), μ = AlgebraicVariable(μ₀))
ldae_ics_full = (q = StateVariable(q₀), p = StateVariable(p₀), v = AlgebraicVariable(v₀),
    λ = AlgebraicVariable(λ₀), μ = AlgebraicVariable(μ₀))
...
sde_params = (λ = 2.0, μ = 1.0, noise_intensity = 0.1)
